...
},{"./dom":20,"lodash":"4HJaAd"}],45:[function(_dereq_,module,exports){
var Quill;

Quill = _dereq_('../src/quill');

Quill.Document = _dereq_('../src/document');

Quill.DOM = _dereq_('../src/dom');

Quill.Editor = _dereq_('../src/editor');

Quill.Format = _dereq_('../src/format');

Quill.Leaf = _dereq_('../src/leaf');

Quill.Line = _dereq_('../src/line');

Quill.Normalizer = _dereq_('../src/normalizer');

Quill.Renderer = _dereq_('../src/renderer');

Quill.Selection = _dereq_('../src/selection');

Quill.Utils = _dereq_('../src/utils');

Quill.Lib = {
  EventEmitter2: _dereq_('eventemitter2').EventEmitter2,
  ColorPicker: _dereq_('../src/lib/color-picker'),
  LinkedList: _dereq_('../src/lib/linked-list'),
  Picker: _dereq_('../src/lib/picker'),
  Range: _dereq_('../src/lib/range')
};

Quill.Module = {
  Authorship: _dereq_('../src/modules/authorship'),
  Keyboard: _dereq_('../src/modules/keyboard'),
  ImageTooltip: _dereq_('../src/modules/image-tooltip'),
  LinkTooltip: _dereq_('../src/modules/link-tooltip'),
  MultiCursor: _dereq_('../src/modules/multi-cursor'),
  PasteManager: _dereq_('../src/modules/paste-manager'),
  Toolbar: _dereq_('../src/modules/toolbar'),
  Tooltip: _dereq_('../src/modules/tooltip'),
  UndoManager: _dereq_('../src/modules/undo-manager')
};

Quill.Theme = {
  Default: _dereq_('../src/themes/default'),
  Snow: _dereq_('../src/themes/snow')
};
...
},{"../src/document":19,"../src/dom":20,"../src/editor":21,"../src/format":22,"../src/leaf":23,"../src/lib/color-picker":24,"../src/lib/linked-list":25,"../src/lib/picker":26,"../src/lib/range":27,"../src/line":28,"../src/modules/authorship":29,"../src/modules/image-tooltip":30,"../src/modules/keyboard":31,"../src/modules/link-tooltip":32,"../src/modules/multi-cursor":33,"../src/modules/paste-manager":34,"../src/modules/toolbar":35,"../src/modules/tooltip":36,"../src/modules/undo-manager":37,"../src/normalizer":38,"../src/quill":39,"../src/renderer":40,"../src/selection":41,"../src/themes/default":42,"../src/themes/snow":43,"../src/utils":44,"eventemitter2":"x/3aRz"}]},{},[45])
(45)
});