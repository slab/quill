describe('UndoManager', ->
  ...
  describe('undo/redo', ->
    ...
    it('hotkeys', ->
      ...
      changed = @quill.getContents()
      expect(changed).not.toEqualDelta(@original)
      Quill.Lib.DOM.triggerEvent(@quill.root, 'keydown', Quill.Module.UndoManager.hotkeys.UNDO)
      expect(@quill.getContents()).toEqualDelta(@original)
      Quill.Lib.DOM.triggerEvent(@quill.root, 'keydown', Quill.Module.UndoManager.hotkeys.REDO)
      expect(@quill.getContents()).toEqualDelta(changed)
    )
  )
)
