...
For most users, the preset builds are the easiest way to get started with Quill.
They include the core Quill library, as well as the most popular themes and modules.

To import a preset build, you will need to include "quill.js" script and the stylesheet for the theme you wish to use.
