...
class BubbleTheme extends BaseTheme {
  ...
  extendToolbar(toolbar) {
    ...
    this.buildButtons([].slice.call(Array.from(toolbar.container.querySelectorAll('button'))), icons);
    this.buildPickers([].slice.call(Array.from(toolbar.container.querySelectorAll('select'))), icons);
  }
}
