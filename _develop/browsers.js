var desktop = {
  'mac-chrome-latest'       : ['OS X 10.12', 'chrome', '58.0'],
  'mac-firefox-latest'      : ['OS X 10.12', 'firefox', '53.0'],
  'mac-safari-latest'       : ['OS X 10.12', 'safari', '10.0'],
  'mac-chrome-previous'     : ['OS X 10.11', 'chrome', '58.0'],
  'mac-firefox-previous'    : ['OS X 10.11', 'firefox', '52.0'],
  'mac-safari-previous'     : ['OS X 10.11', 'safari', '9.0'],

  'windows-chrome-latest'   : ['Windows 10', 'chrome', '58.0'],
  'windows-firefox-latest'  : ['Windows 10', 'firefox', '53.0'],
  'windows-edge-latest'     : ['Windows 10', 'microsoftedge', '14.14393'],
  'windows-ie-latest'       : ['Windows 8.1', 'internet explorer', '11.0'],
  'windows-chrome-previous' : ['Windows 8.1', 'chrome', '58.0'],
  'windows-firefox-previous': ['Windows 8.1', 'firefox', '52.0'],
